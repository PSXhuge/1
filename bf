...
local Stats = RenUi:AddTab("统计数据","7040410130")
local Teleport = RenUi:AddTab("传送岛屿","6035190846")
local Dungeon = RenUi:AddTab("突袭功能","7044284832")
local DevilFruit = RenUi:AddTab("恶魔果","7044233235")
local Shop = RenUi:AddTab("商店","6031265976")
local Misc = RenUi:AddTab("设置","6034509993")
--------------------------------------------------------------------
Main:AddSeperator("你看你🐴币")
...
Main:AddToggle("自己翻译，看你🐴币",function()
